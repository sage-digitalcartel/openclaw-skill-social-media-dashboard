"""
Metricool API integration for Social Media Dashboard
"""
...
METROOL_API_BASE = "https://api.metricool.com"
...
class MetricoolClient:
    ...
    def get_channels(self, workspace_id: str) -> List[Dict]:
        ...
        response = requests.get(
            f"{METROOL_API_BASE}/workspaces/{workspace_id}/channels",
            headers=self.headers
        )
        return response.json().get("data", [])
    ...
    def create_post(
        ...
        response = requests.post(
            f"{METROOL_API_BASE}/workspaces/{workspace_id}/posts",
            headers=self.headers,
            json=post_data
        )
    ...
    def publish_post(self, workspace_id: str, post_id: str) -> Dict:
        ...
        response = requests.post(
            f"{METROOL_API_BASE}/workspaces/{workspace_id}/posts/{post_id}/publish",
            headers=self.headers
        )
        return response.json()
    ...
    def delete_post(self, workspace_id: str, post_id: str) -> Dict:
        ...
        response = requests.delete(
            f"{METROOL_API_BASE}/workspaces/{workspace_id}/posts/{post_id}",
            headers=self.headers
        )
        return response.json()
